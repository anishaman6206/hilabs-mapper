...
# SNOMED case ---
q1 = "Bilirubin"
cand1 = retrievers["SNOMEDCT_US"].topk(q1, k=10)  
r1 = rank_candidates(q1, "Lab", "SNOMEDCT_US", cand1)

r1 = apply_display_for_candidates("SNOMEDCT_US", r1, vocabs["SNOMEDCT_US"], entity_type="Lab")
...
# RxNorm case ---
q2 = "aspirin 10 mg"
cand2 = retrievers["RXNORM"].topk(q2, k=10)
